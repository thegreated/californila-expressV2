...
class Faq extends BaseController
{
    ...
    private $dataName = 'Faq';
    private $dbName = 'faqs';
    private $address = 'faqlist';
    ...
    function my_admin_menu() {
      //  add_submenu_page('californila_plugin', 'Faq', 'Faq', 'manage_categories', 'edit.php?post_type=faq');
    }
    ...
    public function setLabels()
    {
        ...
        $this->labels =array(
            ...
            'menu_name'             => _x( 'Faq', 'Admin Menu text',  $this->address  ),
